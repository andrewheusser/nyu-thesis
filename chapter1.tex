...
\begin{table}[ht]
\centering
\caption{Behavioral Experiment 1 Results}
\label{Behavioral Experiment 1 Results}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllllll}
Experiment 1 & n = 24 &  &  &  &  &  \\
 &  &  &  &  &  &  \\
Event Position & 1 & 2 & 3 & 4 & 5 & 6 \\
Encoding Task Response Times & 1.90 (.29) & 1.59 (.26) & 1.57 (.25) & 1.53 (.27) & 1.53 (.26) & 1.55 (.27) \\
 &  &  &  &  &  &  \\
Color Memory Test &  &  &  &  &  &  \\
 &  &  &  &  &  &  \\
Overall Accuracy & .81 (.16) & .75 (.14) & .74 (.16) & .74 (.14) & .74 (.17) & .74 (.17) \\
High Confidence Accuracy & .88 (.15) & .80 (.16 & .82 (.17) & .84 (.15) & .80 (.16) & .81 (.18) \\
Low Confidence Accuracy & .52 (.27) & .57 (.27) & .60 (.24) & .52 (.23) & .65 (.21) & .61 (.21) \\
 &  &  &  &  &  &  \\
Correct Retrieval RTs & 2.23 (1.04) & 2.47 (1.18) & 2.39 (1.11) & 2.49 (1.04) & 2.47 (1.15) & 2.64 (1.30) \\
High Confidence Correct Retrieval RTs & 2.14 (1.03) & 2.33 (1.22) & 2.31 (1.22) & 2.22 (.90) & 2.29 (1.11) & 2.25 (.87) \\
Low Confidence Correct Retrieval RTs & 3.00 (1.18) & 3.41 (1.51) & 3.34 (1.73) & 3.79 (1.55) & 3.44 (1.66) & 3.78 (1.72)
\end{tabular}%
}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Behavioral Experiment 2 Results}
\label{Behavioral Experiment 2 Results}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllllll}
Experiment 2 & n = 24 &  &  &  &  &  \\
 &  &  &  &  &  &  \\
Event Position & 1 & 2 & 3 & 4 & 5 & 6 \\
Encoding Task Response Times (s) & 2.13 (.47) & 1.87 (.44) & 1.85 (.44) & 1.79 (.43) & 1.82 (.44) & 1.81 (.43) \\
 &  &  &  &  &  &  \\
 & Boundary & Non-boundary & Across-Event & Within-Event &  &  \\
Color Memory Test &  &  &  &  &  &  \\
 &  &  &  &  &  &  \\
Overall Accuracy & .89 (.07) & .82 (.10) & - & - &  &  \\
High Confidence Accuracy & .94 (.05) & .88 (.10) & - & - &  &  \\
Low Confidence Accuracy & .66 (.16) & .64 (.14) & - & - &  &  \\
 &  &  &  &  &  &  \\
Correct Retrieval RTs & 2.37 (.95) & 2.99 (1.10) & - & - &  &  \\
High Confidence Correct Retrieval RTs & 2.17 (.82) & 2.69 (.99) & - & - &  &  \\
Low Confidence Correct Retrieval RTs & 4.62 (3.06) & 4.90 (2.50) & - & - &  &  \\
 &  &  &  &  &  &  \\
Order Memory Test &  &  &  &  &  &  \\
 &  &  &  &  &  &  \\
Overall Accuracy & - & - & .63 (.09) & .77 (.10) &  &  \\
High Confidence Accuracy & - & - & .67 (.13) & .84 (.09) &  &  \\
Low Confidence Accuracy & - & - & .58 (.08) & .64 (.12) &  &  \\
 &  &  &  &  &  &  \\
Correct Retrieval RTs & - & - & 4.78 (2.42) & 3.83 (1.39) &  &  \\
High Confidence Correct Retrieval RTs & - & - & 4.25 (1.79) & 3.55 (1.18) &  &  \\
Low Confidence Correct Retrieval RTs & - & - & 5.58 (2.96) & 4.99 (2.34) &  &
\end{tabular}%
}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Behavioral Experiment 3 Results}
\label{Behavioral Experiment 3 Results}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllll}
Experiment 3 & n = 23 &  &  &  \\
 &  &  &  &  \\
Event Position & 1 & 2 & 3 & 4 \\
Encoding Task Response Times & 1.85 (.28) & 1.71 (.24) & 1.70 (.26) & 1.69 (.27) \\
 &  &  &  &  \\
Color Memory Test &  &  &  &  \\
 &  &  &  &  \\
Overall Accuracy & .77 (.14) & .73 (.15) & .73 (.13) & .74 (.12) \\
High Confidence Accuracy & .84 (.15) & .84 (.14) & .80 (.18) & .83 (.12) \\
Low Confidence Accuracy & .70 (.21) & .60 (.19) & .61 (.21) & .61 (.16) \\
 &  &  &  &  \\
Correct Retrieval RTs & 1.66 (.49) & 1.91 (.56) & 1.80 (.49) & 1.92 (.54) \\
High Confidence Correct Retrieval RTs & 1.52 (.41) & 1.77 (.59) & 1.65 (.49) & 1.79 (.63) \\
Low Confidence Correct Retrieval RTs & 2.30 (1.05) & 2.68 (.98) & 2.90 (2.00) & 2.72 (1.17)
\end{tabular}%
}
\end{table}
